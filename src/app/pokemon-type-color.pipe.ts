  ...
  transform(type: string): string {
    ...
    switch (type) {
      ...
      case 'Vol': color = 'blue lighten-3';
        break;
      case 'Poison': color = 'deep-purple accent-1';
        break;
      case 'Fée': color = 'pink lighten-4';
        break;
      case 'Psy': color = 'deep-purple darken-2';
        break;
      case 'Electrick': color = 'lime accent-1';
        break;
      case 'Combat': color = 'deep-orange';
        break;
      default: color = 'grey';
        break;
    }
